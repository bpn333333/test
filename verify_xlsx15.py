...
check("損益計算書", "人件費（社員）", [44, 77, 129, 161, 187], 2, None, "%10.0f")
check("損益計算書", "開発委託費（オフショア）", [46, 74, 111, 139, 148], 3, None, "%10.0f")
check("損益計算書", "獲得費", [8, 61, 236, 590, 1038], 4, None, "%10.0f")
check("損益計算書", "営業利益", [-114, -169, 347, 1808, 3641], 20, None, "%10.0f")
check("損益計算書", "社員数", [5, 9, 15, 19, 22], 0.5, None, "%10.0f")
