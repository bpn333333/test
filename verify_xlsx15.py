...
check("商品マスタ③", "GMV 合計", [11, 140, 1665, 5272, 9271], 15, None, "%10.0f")
check("商品マスタ③", "③ 売上（手数料30%）", [3, 42, 499, 1582, 2781], 5, None, "%10.0f")
check("商品マスタ③", "売上総利益", [3, 33, 393, 1248, 2196], 8, None, "%10.0f")
...
check("損益計算書", "③ C2C手数料", [3, 42, 499, 1582, 2781], 5, None, "%10.0f")
check("損益計算書", "売上高", [42, 318, 2099, 5885, 10509], 12, None, "%10.0f")
check("損益計算書", "売上総利益", [15, 182, 1448, 4302, 7893], 12, None, "%10.0f")
check("損益計算書", "人件費（社員）", [53, 114, 260, 417, 556], 2, None, "%10.0f")
check("損益計算書", "獲得費", [8, 61, 236, 590, 1038], 4, None, "%10.0f")
check("損益計算書", "営業利益", [-77, -138, 282, 1559, 3193], 15, None, "%10.0f")
check("損益計算書", "社員数", [6, 13, 29, 46, 61], 0.5, None, "%10.0f")
