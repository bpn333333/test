...
check("損益計算書", "人件費（社員）", [44, 77, 140, 194, 224], 2, None, "%10.0f")
check("損益計算書", "開発委託費（オフショア）", [38, 75, 150, 225, 300], 3, None, "%10.0f")
check("損益計算書", "獲得費", [8, 61, 236, 590, 1038], 4, None, "%10.0f")
check("損益計算書", "営業利益", [-106, -170, 297, 1689, 3451], 20, None, "%10.0f")
check("損益計算書", "社員数", [5, 9, 16, 22, 25], 0.5, None, "%10.0f")
