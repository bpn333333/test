...
/* ═══════════ 12. ユニットエコノミクス ═══════════ */
{
  ...
  const rowsC=[
    ...
    [{text:"★ 次版で中点成約に変更",options:{bold:true,color:VERM}},{text:"→ 約9.3万",options:{color:VERM}},{text:"上限成約は上振れシナリオとして別に持つ",options:{color:VERM}}],
  ...
  foot(s, "①の単価は企業の現行支払の50%。★③の価格は次版で「上限成約」から「中点成約」へ変更します（上限成約は上振れシナリオとして併記）。本版の数値は上限成約のままです");
}
...
/* ═══════════ 24. マイルストーン ═══════════ */
{
  ...
  warn(s, M, 4.98, W, 1.26, "最優先で実測するのは ③の成約価格です",
    ["★ 次版から中点成約を基準にします。上限成約（本版の数値）は上振れシナリオとして併記します。",
...
/* ═══════════ 26. リスクと対策 ═══════════ */
{
  ...
  const rows=[
    ...
    [{text:"2",options:{bold:true}},{text:"高",options:{bold:true,color:VERM}},{text:"中",options:{color:VERM}},{text:"③が価格帯の上限で成約しない",options:{bold:true}},"★次版から中点成約を基準に置き直す。上限成約は上振れシナリオとして別扱い。件数と単価の両方を1期から実測する"],
