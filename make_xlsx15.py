...
OFF = [
    ("ベトナム", 50.0, 59.0, 0.70, "オフショア開発.com 2026（シニア／ブリッジSE）。主軸"),
    ("インド", 45.0, 60.0, 0.30, "同上。ベトナムより1割安く、英語圏で層が厚い"),
    ("中国", 71.7, 75.8, 0.00, "参考。高いため外した"),
    ("東欧", 104.0, 124.8, 0.00,
     "参考。Devico/RemoteMore/Wild.Codes 2026（月160h・150円換算）。最も高いため外した"),
]
...
put(H, 26, 1, "シニア級 加重（万円/年）", font=F_B)
put(H, 26, 2, "=SUMPRODUCT(B21:B24,D21:D24)*12", fmt=N, fill=CALCBG, align="right")
put(H, 27, 1, "リード級 加重（万円/年）", font=F_B)
put(H, 27, 2, "=SUMPRODUCT(C21:C24,D21:D24)*12", fmt=N, fill=KEYBG, align="right", font=F_B)
put(H, 27, 8, "AX前提はこちらを使う。人数を減らすかわりに上位層に絞る", font=F_S)
put(H, 28, 1, "⚠ 安い順は ミャンマー(40)＜インド(45)＜フィリピン(47.5)＜ベトナム(50)＜中国(71.7)＜東欧(104)。"
             "「中国が安い」のは剪辑師（月18.8万）の話で、エンジニアの受託単価ではない。",
    font=F_R, border=False)
put(H, 29, 1, "⚠ ロシア・ベラルーシは対象外。外為法の役務取引規制（2022/3/18〜）で経産大臣の許可制、"
...
OFFD = [
    ...
    (36, "開発委託費（百万円）", None, "=C34*$B$27/100", "実人数 × リード級の年額"),
]
