...
英語圏では「AIエージェントにトレードをやらせる」という切り口まで既に出版済み。

### 競合状況(日本語圏)— こちらの方が近接度が高い

**日本市場も空いていない。むしろ企画がほぼ一致するタイトルが既に存在する。**

| 分類 | 確認できたタイトル |
|---|---|
| **AIエージェント × FX自動売買** | **「AIエージェントFX投資術 10分でわかる完全自動化ガイド」【chatgpt】【Claude】【Gemini】**(AI活用投資家Sora / 雲水書房) |
| **Claude × 投資** | **「AIを投資の武器にする技術: Claude Code株式投資実践術」**(AIツール解体新書) |
| AI × EA作成 | 「ChatGPTでつくる！かんたんEA作成実践ガイド」(THE KENVO) |
| AI × EAロジック | 「最強EAロジック設計術！初心者でも勝率アップ&資産を増やす裏ワザ公開 — AIが導く自動売買の新常識」(FX解体新書) |
| Python × MT5 | 「MT5の限界を突破！Python自動売買で『月50万円』を狙う稼げる最強EA開発法」(FX解体新書) |
| MQL5入門 | 「ゼロから始めるMT5 EA開発 MQL5自動売買プログラミング入門」(パイナップル)ほか複数 |
| 商業出版(MT4世代) | 「FX自動売買ロボット作成マニュアル」(山口孝志)、「MetaTrader 4で始める FX自動売買システム作成の教科書」(星野慶次) |
| Claude一般書(参考) | 「3時間で身につくClaude活用術」(尾藤克之)、「ClaudeによるAIエージェント開発入門」(掌田津耶乃) |

**観察されること:**

1. **「AI × FX自動売買」という企画は、日本語でも既に埋まっている。**
   特に「AIエージェントFX投資術」は本人の構想とほぼ同じ切り口
2. ただし**大半がKDPの量産型に見える。**「FX解体新書」「AIツール解体新書」
   「雲水書房」といった屋号が複数タイトルを短期間に出しており、
   タイトルは「最強」「裏ワザ」「月50万円」「10分でわかる」と煽り寄り
3. **検証記録を持っている本は見当たらない。** どれも「作り方」「使い方」であって
   「実際に検証して、何が落ちたか」ではない
4. **「日本語で書かれた、海外(MQL5 Market)向けEA販売の実務書」が見当たらない。**
   日本語の書籍は国内販売か開発入門に寄っており、
   出品審査・規約・DLL禁止といった実務の記述は確認できなかった

### 差別化しうる線(空いている可能性がある順)

| # | 切り口 | 空き具合 | 根拠 |
|---|---|---|---|
| 1 | **検証記録:「AIと作ったEAを検証したら、ほとんど落ちた」** | 空いている | 量産型は成功前提でしか書かれていない。失敗の記録は模倣が難しい |
| 2 | **海外販売の実務: MQL5 Market への出品審査・規約・DLL禁止** | 空いている | 日本語での該当書が見つからない。Seller登録には身分証と自撮りの提出が必要など、経験しないと書けない情報 |
| 3 | AI × FX自動売買の入門 | **埋まっている** | 上表のとおり近接タイトルが複数。後発では埋もれる |

> **結論(日本市場):** 英語圏と同じく、**一般論では埋もれる。**
> ただし 1(検証記録)と 2(海外販売の実務)は、
> **実際にやった人にしか書けないため、実行が先行すれば書ける。**
> つまり **Kindle は「先に書く」ものではなく「やった結果として書く」もの。**
> フェーズ2〜4を実行してから執筆する順序が正しい。

これは既存 HANDOFF.md にある「管理職向けAI教育」の Kindle 戦略とは
別テーマとして立つ。
...
| 4 | Kindle | 単体の収益より、実績と信用の可視化。**英語圏・日本語圏とも一般論では埋もれる。書けるのは「検証記録」と「海外販売の実務」** |
...
- [AIエージェントFX投資術 10分でわかる完全自動化ガイド (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0FP8ZR96Z)
- [AIを投資の武器にする技術: Claude Code株式投資実践術 (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0GY69W48Y)
- [ChatGPTでつくる！かんたんEA作成実践ガイド (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0FCSG8MVQ)
- [最強EAロジック設計術！ (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0GHMKMMGL)
- [MT5の限界を突破！Python自動売買で『月50万円』を狙う (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0G2N5J2KR)
- [ゼロから始めるMT5 EA開発 MQL5自動売買プログラミング入門 (Amazon.co.jp)](https://www.amazon.co.jp/dp/B0FXXLLRHV)
- [EA出品の注意点｜MQL5.com編 (HANDY SYSTEMS / note)](https://note.com/handy_systems/n/n1b8184f4cc9e)
