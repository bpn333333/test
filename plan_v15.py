...
UNITS = [60, 304, 1208, 2464, 3494]          # sales.py（②の解約が制作会社チャネルに波及）
...
# ── ② ツール外販（据え置き）────────────────────────────
CORP = [0, 15, 96, 287, 481]        # 期末（★解約率30%適用後）
...
GMV = [19, 203, 1782, 5319, 9179]
C2C_BUILD = [6, 61, 535, 1596, 2754]      # 手数料30%・価格は上限・③-C件数を120億に調整
