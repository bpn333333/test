...
S3 = [
    ...
    ("個人オーダーメイド", "C", 3.0, 10.0, 150000, 5900, "パッケージに収まらない個別要望"),
    ("企業オーダーメイド", "C", 10.0, 50.0, 1000000, 8900, "上限100万。月742件"),
]
r = 5
...
# 知財
# ══════════════════════════════════════════════════════════════
IP = sheet("知財", [30, 14, 44, 46])
title(IP, "知財 — 支払う側と、取る側",
      "AI映像は「他人の権利を使って作り、自分の権利を積む」事業。両方を1枚で持つ。")
