# -*- coding: utf-8 -*-
"""事業計画_Ver1.6.xlsx を実際に再計算し、plan_v15.py と突き合わせる
...
check("商品マスタ③", "GMV 合計", [19, 248, 3134, 10019, 17663], 30, None, "%10.0f")
check("商品マスタ③", "③ 売上（手数料30%）", [6, 74, 940, 3006, 5299], 12, None, "%10.0f")
check("商品マスタ③", "売上総利益", [4, 59, 745, 2383, 4202], 12, None, "%10.0f")
...
check("損益計算書", "③ C2C手数料", [6, 74, 940, 3006, 5299], 12, None, "%10.0f")
check("損益計算書", "売上高", [45, 350, 2540, 7309, 13027], 30, None, "%10.0f")
check("損益計算書", "売上総利益", [18, 208, 1800, 5437, 9898], 30, None, "%10.0f")
...
check("損益計算書", "営業利益", [-92, -123, 673, 2798, 5367], 30, None, "%10.0f")
