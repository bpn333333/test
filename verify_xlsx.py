...
check("商品マスタ③", "売上総利益", [4, 59, 623, 1937, 3390], 15, None, "%10.0f")
...
check("損益計算書", "売上高", [45, 350, 2386, 6745, 12005], 40, None, "%10.0f")
check("損益計算書", "売上総利益", [18, 208, 1678, 4989, 9087], 40, None, "%10.0f")
...
check("損益計算書", "営業利益", [-96, -124, 546, 2339, 4535], 40, None, "%10.0f")
