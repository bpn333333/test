...
check("商品マスタ③", "GMV 合計", [19, 203, 1782, 5319, 9179], 40, None, "%10.0f")
check("商品マスタ③", "③ 売上（手数料30%）", [6, 61, 535, 1596, 2754], 15, None, "%10.0f")
check("商品マスタ③", "売上総利益", [4, 48, 423, 1264, 2181], 15, None, "%10.0f")
...
check("損益計算書", "③ C2C手数料", [6, 61, 535, 1596, 2754], 15, None, "%10.0f")
check("損益計算書", "売上高", [45, 336, 2130, 5797, 10022], 60, None, "%10.0f")
check("損益計算書", "売上総利益", [18, 197, 1475, 4238, 7516], 60, None, "%10.0f")
...
check("損益計算書", "営業利益", [-101, -146, 311, 1584, 2947], 60, None, "%10.0f")
