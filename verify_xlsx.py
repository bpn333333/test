...
check("商品マスタ②", "② 売上 合計（百万円）", [0, 46, 556, 1935, 3747], 6, None, "%10.0f")
...
check("損益計算書", "② ツール外販", [0, 46, 556, 1935, 3747], 6, None, "%10.0f")
check("損益計算書", "③ C2C手数料", [6, 74, 786, 2442, 4274], 15, None, "%10.0f")
check("損益計算書", "売上高", [45, 350, 2382, 6643, 11543], 60, None, "%10.0f")
check("損益計算書", "売上総利益", [18, 208, 1675, 4910, 8724], 60, None, "%10.0f")
check("損益計算書", "人件費（社員）", [50, 77, 129, 172, 187], 2, None, "%10.0f")
check("損益計算書", "開発委託費（オフショア）", [26, 47, 74, 84, 100], 3, None, "%10.0f")
check("損益計算書", "獲得費", [8, 61, 236, 576, 973], 8, None, "%10.0f")
check("損益計算書", "営業利益", [-109, -133, 498, 2214, 4078], 60, None, "%10.0f")
